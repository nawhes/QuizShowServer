...
contract QuizShowToken is ERC20Interface, Owned {
    ...
    // constructor(string  _symbol, string  _name, uint8 _decimals, uint _total) public {
    //     symbol = _symbol;
    //     name = _name;
    //     decimals = _decimals;
    ...
    // ------------------------------------------------------------------------
    function reserveQuiz(string  _datetime, string  _prize_kind, uint _prize_amount) public onlyOwner {
    ...
    //  state            상태
    // ------------------------------------------------------------------------
    function getQuizList(uint _no) public view returns(string  datetime, string  prize_kind, string  hash_db, uint prize_amount,uint no_winner,uint state){
    ...
    // _no 는 0부터 시작     
    // ------------------------------------------------------------------------    
    function editQuizList(uint _no, string  _datetime, string  _prize_kind, string  _hash_db, uint _prize_amount,uint _no_winner,uint8 _state) public onlyOwner {
        require(gamelists.length > _no );
